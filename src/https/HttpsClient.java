...
CLIENT_CERT_PWD="123456"; private static String
  * TRUST_CERT_PATH=
  * 
...
KeyManagementException,
   NoSuchAlgorithmException, ClientProtocolException, 
IOException {
  // sendMsgOfCert("https://10.25.32.13:8007", "hello world", 
"123456",
  // "kserver.jks", "123456", 
"tclient.jks");
  send(
 ...
 public static String sendMsgOfCert(String urlString, String 
requestData,
   String CLIENT_CERT_PWD, String CLIENT_CERT_PATH,
   String 
TRUST_CERT_PWD, String TRUST_CERT_PATH) {
...
true;
   ...
   URL url = new 
URL(urlString);
   HttpsURLConnection urlCon = (HttpsURLConnection) 
url
     .openConnection();
   ...
   InputStream fis = new 
ByteArrayInputStream(requestData
     .getBytes("GB18030"));
   BufferedInputStream 
   ...
   // if (ret != null && !ret.trim().equals("")) 
{
   ...
   // + new 
String(ret.getBytes("ISO-8859-1"), "GBK");
   // }
   // }
   // 
...
e.getMessage());
   throw new 
RuntimeException("https调用失败！");
  }
  return null;
 }

 public static void send(String requsetString, String 
requestData)
   throws NoSuchAlgorithmException, 
KeyManagementException,
...
TrustManager[] { trustManager }, null);
  ...
  // (I found 
trying to extend the factory a bit difficult due to a
  // call to 
createSocket with no arguments, a method which doesn't
  // exist anywhere I 
can find, but hey-ho).
...
Scheme("https", sf, 443));
  ...
  HttpPost 
httpPost = new HttpPost(requsetString);
  String result = "";
  // Execute 
HTTP request
